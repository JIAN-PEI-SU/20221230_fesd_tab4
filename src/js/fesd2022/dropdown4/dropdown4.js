  ...
  #event() {
    ...
    const bindScrollbar = (d4 = this) => {
      ...
      d4.__scroller__ = OverlayScrollbars(scroller, {
        callbacks: {
          onInitialized() {
            scroller.querySelector('.os-viewport').classList.remove('os-viewport-native-scrollbars-overlaid')
            scroller.querySelector('.os-viewport').classList.add('os-viewport-native-scrollbars-invisible')
          },
        },
      })
    }
